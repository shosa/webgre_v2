<fieldset>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input type="text" name="nome" autocomplete="off" placeholder="nome" class="form-control"
                    value="<?php echo ($edit) ? $admin_account['nome'] : ''; ?>" autocomplete="off">
            </div>
        </div>
    </div>
    <!-- Text input-->
    ...
    <!-- radio checks -->
    <div class="form-group">
        <label class="col-md-4 control-label">Tipo di utente</label>
        <div class="col-md-4">
            <div class="radio">
                <label>
            ...
            <div class="radio">
                <label>
                    <input type="radio" name="admin_type" value="utente" required="" <?php echo ($edit && $admin_account['admin_type'] == 'utente') ? "checked" : ""; ?> /> Utente
                </label>
            </div>
            <div class="radio">
                <label>
                    <input type="radio" name="admin_type" value="lavorante" required="" <?php echo ($edit && $admin_account['admin_type'] == 'lavorante') ? "checked" : ""; ?> /> Lavorante
                </label>
            </div>
        </div>
    </div>
