...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header page-action-links text-left">Cedola #
                <?php echo $idrip ?>
            </h1>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="riparazioni.php" class="btn btn-warning"><i class="fas fa-arrow-left"></i> INDIETRO</a>
                <a href="add_step1.php?operation=create" class="btn btn-success"><i class="fas fa-plus"></i>
                    NUOVA</a>
            </div>
        </div>
    </div>
