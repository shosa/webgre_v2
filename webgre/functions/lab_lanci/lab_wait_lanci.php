...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Lanci in preparazione per
                <b>
                    <?php echo $labValue; ?>
                </b>
            </h1>
    ...
    <div class="well text-center filter-form">
        <b>Qui sono riportati, raggruppati per linea di produzione, i lanci in fase di preparazione a voi assegnati,
            fino alla spedizione presso la vostra sede. </b>
    </div>
    <hr>
    <!-- //Filters -->
        ...
        <table class="table table-striped table-bordered table-condensed">
            <thead>
                <tr>
                    ...
                    <th width="30%">Linea <a style="float:right; color:black;">
