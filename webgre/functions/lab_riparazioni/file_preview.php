...
<div id="page-wrapper">
    <div class="row">
        <div class="row">
            <div class="col-lg-6">
                <h1 class="page-header">Cedola #
                    <?php echo $idrip ?>
                </h1>
            </div>
            <div class="col-lg-6">
                <div class="page-action-links text-right">
                    <a href="riparazioni.php" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i>
                        INDIETRO</a>

                    <a href="add_step1.php?operation=create" class="btn btn-success"><i
    ...
    <div class="anteprima">
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            $pdf->write1DBarcode($idrip, 'C128', '', '', '', 20, 0.4, $style, 'N');

            // Invia il PDF al browser
            $pdfData = $pdf->Output($filename, 'S');

            // Visualizza il PDF nel div "anteprima"
            echo '<embed src="data:application/pdf;base64,' . base64_encode($pdfData) . '" type="application/pdf" width="100%" height="1000px;"/>';
        } else {
