...
// Costumers class
require_once BASE_PATH . '/lib/Laboratori/Laboratori.php';
$associazioni = new Laboratori();
...
$rows = $db->arraybuilder()->paginate('laboratori', $page, $select);
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header page-action-links text-left">Tabella Laboratori</h1>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_laboratori.php?operation=create" class="btn btn-success"><i
                        class="glyphicon glyphicon-plus"></i>NUOVO</a>
            </div>
        </div>
    </div>
    <hr>
    ...
    <div class="well text-center filter-form" style="background-color:#f2f2f2;padding:1%;border-radius:20px;">
        <form class="form form-inline" action="">
            ...
            <input type="text" class="form-control" id="input_search" name="search_string" value=""
                placeholder="Nome Laboratorio" style="margin-right:1%">
