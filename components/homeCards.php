        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-0 shadow-sm h-100 card-hover rounded-lg overflow-hidden">
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink3">
                                <a class="dropdown-item" href="<?php echo BASE_URL ?>/functions/quality/detail?date=<?php echo $data_oggi ?>">
                                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Visualizza dettagli
                                </a>
                    ...
                    <div class="text-center">
                        ...
                        <div class="progress progress-sm mt-2">
                            <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $percentualeSuccesso; ?>%" 
                ...
                <div class="card-footer py-2 bg-light d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo BASE_URL ?>/functions/quality/detail?date=<?php echo $data_oggi ?>" class="small text-info">
                        Dettagli <i class="fas fa-chevron-right ml-1"></i>
                    </a>
                </div>
            </div>
    ...
    <?php if (isset($_SESSION['permessi_produzione']) && $_SESSION['permessi_produzione'] == 1 && $mostraCardProduzione):
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-0 shadow-sm h-100 card-hover rounded-lg overflow-hidden">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink4">
                                <a class="dropdown-item" href="<?php echo BASE_URL ?>/functions/production/produzione?month=<?php echo $mese_odierno; ?>&day=<?php echo $giorno_odierno; ?>">
                                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Visualizza dettagli
                                </a>
                    ...
                    <div class="text-center">
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            <div class="text-center p-2">
                                <div class="h5 mb-0 font-weight-bold text-danger"><?php echo number_format($totaleTaglio, 0, ',', '.'); ?></div>
                            ...
                            <div class="text-center p-2">
                                <div class="h5 mb-0 font-weight-bold text-primary"><?php echo number_format($totaleOrlatura, 0, ',', '.'); ?></div>
                            ...
                            <div class="text-center p-2">
                                <div class="h5 mb-0 font-weight-bold text-success"><?php echo number_format($totaleMontaggio, 0, ',', '.'); ?></div>
                                <small class="text-muted font-weight-bold d-block mt-1">MONTAGGIO</small>
                                <?php if ($totaleComplessivo > 0): ?>
                                <div class="progress progress-sm mt-1" style="height: 4px;">
                                    <div class="progress-bar bg-success" style="width: <?php echo $percMontaggio; ?>%"></div>
                                </div>
                ...
                <div class="card-footer py-2 bg-light d-flex justify-content-between align-items-center">
                    <span class="small text-muted">Data: <?php echo $data_oggi; ?></span>
                    <a href="<?php echo BASE_URL ?>/functions/production/produzione?month=<?php echo $mese_odierno; ?>&day=<?php echo $giorno_odierno; ?>" class="small text-danger">
                        Dettagli <i class="fas fa-chevron-right ml-1"></i>
                    </a>
                </div>
            </div>
