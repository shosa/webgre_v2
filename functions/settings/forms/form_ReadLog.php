    ...
    <form id="logForm">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6">
                <button type="button" id="saveBtn" class="btn btn-block btn-success"><i
                        class="fal fa-floppy-disk"></i> Salva</button>
            </div>
            <div class="col-xl-6 col-lg-6">
                <button type="button" id="clearBtn" class="btn btn-block btn-danger"><i
                class="fal fa-broom"></i> Svuota</button>
            </div>
        </div>
