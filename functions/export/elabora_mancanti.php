...
try {
    ...
    $stmt = $conn->prepare("SELECT id, codice_articolo, qta_originale, qta_reale 
    ...
    $stmt = $conn->prepare("INSERT INTO exp_dati_mancanti (id_documento, codice_articolo, qta_mancante) 
                          VALUES (:id_documento, :codice_articolo, :qta_mancante)");
