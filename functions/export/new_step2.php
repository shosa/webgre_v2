...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header page-action-links text-left"><a style="color:#0d6efd;">STEP 2 </a> > Caricamento
                Schede DDT n°
    ...
    <div class="row">
        <div class="col-lg-12 text-right">
            ...
            <button type="button" class="btn btn-primary float-end" onclick="navigateToStep3()">Avanti</button>
        </div>
    </div>
    <!-- Excel Content Modal -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="modello"
                        style="background-color:#f0e8fc;border-radius:2px;padding:4px;margin-bottom:10px;"></div>
                    <div id="opzioni"
                        style="background-color:#e8f0fc;border-radius:2px;padding:4px;margin-bottom:10px;"></div>
                    <h4>TAGLIO</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-save" onclick="saveToExcel()">SALVA</button>
                </div>
            </div>
        </div>
    </div>
