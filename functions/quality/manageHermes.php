                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="records" role="tabpanel" aria-labelledby="records-tab">
                                    ...
                                    <div id="calendar-records-container" class="mt-3">
                                        ...
                                        <!-- Records sulla destra -->
                                        <div id="records-wrapper" class="card shadow">
                                            <div
                                                class="card-header py-3 d-flex justify-content-between align-items-center">
                                                <h6 class="m-0 font-weight-bold text-primary" id="records-date-header">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div id="record-exceptions-section" class="mt-4" style="display: none;">
                                                    <div class="card">
                                                        <div
                                                            class="card-header py-3 d-flex justify-content-between align-items-center">
                                                            <h6 class="m-0 font-weight-bold text-warning">Eccezioni del
