                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="numero_cartellino" name="numero_cartellino"
                                                                required>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" id="linea"
                                                                name="linea" maxlength="2" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="addExceptionForm" enctype="multipart/form-data">
                                                    <input type="hidden" id="exception_cartellino_id"
                                                        name="cartellino_id">
                                                    <div class="form-group">
                                                        <label for="taglia">Taglia*</label>
                                                        <input type="text" class="form-control" id="taglia"
                                                            name="taglia" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="tipo_difetto">Tipo Difetto*</label>
                                                        <select class="form-control" id="tipo_difetto"
                                                            name="tipo_difetto" required>
                                                            <!-- Opzioni caricate dinamicamente con JavaScript -->
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    <img id="exceptionPhoto" src="" class="img-fluid"
                                                        alt="Foto eccezione">
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                ...
                                                <div class="modal-body">
                                                    <form id="addDepartmentForm">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" id="ordine"
                                                    ...
                                                    <form id="addDefectForm">
                                                        ...
                                                        <div class="form-check">
                                                            <input type="checkbox" class="form-check-input"
                                                                id="defect_attivo" name="attivo" checked>
                                                            <label class="form-check-label"
                                                                for="defect_attivo">Attivo</label>
                                                        </div>
                                                    </form>
                                                </div>
                                                <div class="modal-footer">
