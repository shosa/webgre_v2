    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="cartellino"
                ...
                placeholder="" class="form-control" required="required" id="cartellino" readonly>
        </div>
        <div class="form-group">
            <label>REPARTO</label>
            <?php
        ...
        <div class="form-group">
            ...
            <input type="data" name="data"
                ...
                placeholder="" class="form-control" id="data">
        </div>
        <div class="form-group">
