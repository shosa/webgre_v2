                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="eti_decode.php" method="POST">
                                <div class="form-group"> <label for="azione">Azione:</label> <select
                                        class="form-control" id="azione" name="azione" required>
                                        <option value="PRELIEVO">PRELIEVO</option>
                                        <option value="VERSAMENTO">VERSAMENTO</option>
                                    </select> </div>
                                <div class="form-group"> <label for="barcodes">Inserisci i barcode:</label> <textarea
                                        class="form-control" id="barcodes" name="barcodes" required
                                        rows="10"></textarea> </div> <button class="btn btn-primary" type="submit"
                                    style="width:100%">GENERA</button>
                            </form>
                        </div>
                    </div>
                </div>
