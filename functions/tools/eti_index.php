...
<head>
    <script src="https://qajavascriptsdktests.azurewebsites.net/JavaScript/dymo.connect.framework.js" type="text/javascript" charset="UTF-8"> </script>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <button id="printButton" class="btn btn-primary"
                                            style="width:100%">STAMPA</button>
                                    </div>
                                    <div class="col-md-4">
                                        <button id="addArticleButton" class="btn btn-warning"
                                            style="width:100%">NUOVO</button>
                                    </div>
                                    <div class="col-md-4">
                                        <button id="decodePageButton" class="btn btn-info"
                                            style="background-color:#6610f2;border-color:#6610f2;width:100%">CREA
                                            LISTA</button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-header" id="printerDetailHeading">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link" data-toggle="collapse"
                                                    data-target="#printerDetailContainer" aria-expanded="true"
                                                    aria-controls="printerDetailContainer">
                                                    Dettagli Etichettatrice:
                                                </button>
                                            </h5>
                                        </div>
                                        <!-- Rimossa la classe "show" per nascondere i dettagli inizialmente -->
                                        <div id="printerDetailContainer" class="collapse"
                                            aria-labelledby="printerDetailHeading" data-parent="#accordion">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="addArticleForm">
                                            ...
                                            <button id="submitArticle" class="btn btn-success" style="width:100%">Salva
                                                Articolo</button>
                                        </form>
                                    </div>
                                </div>
